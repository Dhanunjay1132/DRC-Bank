...
function Withdraw({ accounts, setAccounts, setActivities }) {
  ...
  const handleWithdraw = () => {
    ...
    const newActivity = {
      type: "Withdraw",
      detail: `₹${amt} withdrawn from ${selectedAccount} - ${account.name}`,
      time: new Date(),
    };

    // Log withdraw activity
    setActivities((prev) => {
      ...
      <div className="flex items-center justify-center mt-16">
        <div className="bg-white/90 backdrop-blur-md w-full max-w-lg rounded-2xl shadow-2xl p-8 transition-transform hover:scale-[1.01]">
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-3xl font-bold text-red-600 font-serif flex items-center gap-2">
              🏧 Withdraw Money
            </h2>
            <Link
              to="/"
              className="px-3 py-2 rounded-lg bg-gray-100 hover:bg-red-500 hover:text-white text-gray-600 text-sm transition"
            >
              ⬅ Back
            </Link>
          </div>
          ...
          <div className="space-y-4">
            <div ref={containerRef} className="relative">
              ...
              <div
                className="w-full border border-gray-300 rounded-lg p-2 mt-1 focus-within:ring-2 focus-within:ring-red-300 cursor-pointer"
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg p-2 mt-1 focus:ring-2 focus:ring-red-300 outline-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-red-500 text-white py-2 rounded-lg hover:bg-red-600 transition font-medium text-lg shadow-md"
            >
              Withdraw Now
            </button>
          </div>
